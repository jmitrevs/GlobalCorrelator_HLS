...
//void mp7wrapped_pfalgo3_onlyPF(MP7DataWord input[MP7_NCHANN], PFChargedObj pfch[NTRACK], PFNeutralObj pfne_all[NNEUTRALS], tk2calo_dr_t drvals[NTRACK][NNEUTRALS], PFChargedObj pfmu[NMU]) ;
void mp7wrapped_pfalgo3_onlyPF(MP7DataWord input[MP7_NCHANN], PFChargedObj pfch[NTRACK], PFNeutralObj pfne_all[NNEUTRALS], PFChargedObj pfmu[NMU]) ;
